...
function abrirJuego(rutaZip, nombreJuego) {
    ...
    window.location.href = `vista.html?actividad=${actividad}&nombre=${nombre}&origen=Humano.html`;
}
...
function goBack() {
  // Redirigir directamente a categorias.html
  window.location.href = 'categorias2.html';
  
  // Si categorias.html está en otra carpeta, usa la ruta completa:
